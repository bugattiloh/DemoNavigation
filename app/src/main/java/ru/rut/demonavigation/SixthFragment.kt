...
class SixthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val button = view.findViewById<Button>(R.id.toFourth1)
        button.setOnClickListener {
            findNavController().navigate(
                R.id.action_sixthFragment_to_fourthFragment,
                null,
                navOptions {
                    anim {
        ...
        view.findViewById<Button>(R.id.toEighth).setOnClickListener {
            findNavController().navigate(
                R.id.action_sixthFragment_to_eighthFragment,
                null,
                navOptions {
                    anim {
